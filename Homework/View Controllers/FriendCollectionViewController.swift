...
class FriendCollectionViewController: UICollectionViewController {
    ...
    private let reuseIdentifier = Constants.Storyboard.FriendPhotoCellIdentifier
    private let profiles: ProfileViewModelProtocol = ProfileViewModel()
    var profileID: Int?
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // Configure the cell
        if let id = profileID {
            cell.photoImageView.image = profiles.photo(for: id)
        }
